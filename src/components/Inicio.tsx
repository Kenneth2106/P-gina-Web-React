...
function Inicio() {
	const planes = [
		{ nivel: "Base", titulo: "DIARIO", detalle: "Control, pase y conducción", sesiones: " 1 sesion / dia", color: "plan-green" },
		{ nivel: "Intermedio", titulo: "SEMANAL", detalle: "Técnica, velocidad y visión", sesiones: "4 sesiones / semana", color: "plan-orange" },
		{ nivel: "Avanzado", titulo: "MENSUAL", detalle: "Potencia, táctica y definición", sesiones: "5 sesiones / semana", color: "plan-dark" }
	];
		...
		<>
			<section className="hero-section">
				<div className="hero-copy">
					...
					<div className="hero-actions"><Link className="button button-dark" to="/registro">Empezar a entrenar <span>↗</span></Link></div>
				</div>
			...
			<section className="invite-section"><p className="eyebrow">Tu próximo entrenamiento</p><h2>La cancha te está esperando.</h2></section>
		</>
	);
}
