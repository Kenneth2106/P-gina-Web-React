		...
		<>
			<section className="hero-section">
				<div className="hero-copy">
					...
					<div className="hero-actions"><a className="button button-dark" href="#planes">Empezar a entrenar <span>↗</span></a><a className="text-link" href="#planes">Ver planes <span>↓</span></a></div>
				</div>
			...
			<section className="invite-section"><p className="eyebrow">Tu próximo entrenamiento</p><h2>La cancha te está esperando.</h2><a className="button button-outline" href="#planes">Ver planes <span>↗</span></a></section>
		</>
	);
}
